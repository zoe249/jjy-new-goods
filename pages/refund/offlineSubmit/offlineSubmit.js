...
*/
  ...
  btnSubmit(){
    ...
    if(that.data.refundReason==-1){
    ...
    }else if(!that.data.userName&&goodsSence==0){
      APP.showToast("请填写联系人");
    }else if(!that.data.userPhone&&goodsSence==0){
      ...
      if(that.data.detailData.orderType==55||goodsSence>0){
  ...
  // /*确定售后原因*/
  // confirmReason(){
  //   let {refundReasonNow,refundReasonTextNow}=this.data;
  //   this.setData({
  //     refundReasonTextNow:refundReasonTextNow,
  //     refundReasonNow:refundReasonNow,
