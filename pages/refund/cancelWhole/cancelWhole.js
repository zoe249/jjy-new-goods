...
*/
  ...
  let that=this;
  let {isB2C,forMPage,orderStoreId,detailData,canClick,remarks,selectReasonValue,minTextNum,shippingTypeNow}=that.data;
      let mobile=wx.getStorageSync('mobile')||'';
      let nickName=wx.getStorageSync('nickName')||'';
      let isApproval=isB2C==1634?false:detailData.addrStete==1020?true:false;
                      ...
                      success(res) {
                        if (res && res._code == API.SUCCESS_CODE) {
                          wx.requestSubscribeMessage({
                            ...
                            wx.redirectTo({
                              url: `/pages/refund/success/success?from=cancelWhole&servicePhone=${servicePhone}&shippingTypeNow=${shippingTypeNow}&id=${id}&aftermarketType=${aftermarketType}&createTime=${createTime}&goodsSence=${goodsSence}`
                            });
                          }
                        });
                        } else {
